...
#in a log file.
logging_file = home_dir + 'Module4Biber' + " " + str(now + ".log")
...
logging.debug(" Gender/genre Module 4Biber: Run " + str(now))
...
def process(section):
        ...
        logging_file = nltkcorpus_dir + "4BiberLog " + section + ".log" #5-1 moved out to global or deleted.
